...
- [ ] 1. Author the v2 smoke gate `scripts/gates/canvas-valid-v2.ts` —
...
- [ ] 2. Generate the v2 canvas via the `canvas-generator-v2` skill — assemble
...
- [ ] 3. Validate the generated canvas against the gate — run
