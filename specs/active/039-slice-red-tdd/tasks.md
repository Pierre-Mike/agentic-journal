...
- [ ] 1. Add taskGates() helper to _lib.ts
  - agent: main
  - depends: []
  - file_targets: [scripts/_lib.ts]
  - boundary: [scripts/_lib.ts]

- [ ] 2. Update tasks.md and proposal.md templates with per-task gate field
  - agent: main
  - depends: [1]
