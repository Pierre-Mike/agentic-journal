...
- [ ] 1. Write RED smoke + unit test stubs (both fail because trace-scan.ts is not yet implemented)
  - agent: main
  - depends: []
  - file_targets: [scripts/smoke-trace-scan.ts, scripts/trace-scan.test.ts]
- [ ] 2. Implement scripts/trace-scan.ts to satisfy the smoke and unit tests (GREEN)
  - agent: main
  - depends: [1]
  - file_targets: [scripts/trace-scan.ts]
- [ ] 3. Write findings.md audit trail (retro origin)
  - agent: main
  - depends: []
