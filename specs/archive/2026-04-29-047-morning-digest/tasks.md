...
- [x] 1. Write gate fixture `scripts/smoke-morning-digest.ts` (RED until task 2 lands)
  - agent: main
  - depends: []
  - file_targets: [scripts/smoke-morning-digest.ts]
  - boundary: [scripts/smoke-morning-digest.ts]

- [x] 2. Write core scan logic `scripts/morning-digest.ts`
  - agent: main
  - depends: []
...
- [x] 4. Land morning-digest skill file
  - agent: main
  - depends: [2]
...
- [x] 5. Document morning digest in `specs/constitution.md` §4
  - agent: main
  - depends: []
