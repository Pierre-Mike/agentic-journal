...
- [x] 1. Write the post `content/posts/templated-engineering.mdx` following the Intent → Why → What → How structure, with valid frontmatter and all four sections non-empty
  - agent: main
  - depends: []
