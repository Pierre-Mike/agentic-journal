...
- [x] Allow Edit/Write of .claude/agents/** in settings.json
  - agent: main
  - depends: []
...
- [x] Add Step 6.5 Refactor pass section to spec-implementer.md
  - agent: main
...
- [x] Replace exit-1 stub with real assertions in smoke-implementer-refactor.ts
  - agent: main
